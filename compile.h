...
void co_binary_op(uchar opcode, struct cnode *result, const struct cnode *op1, const struct cnode *op2);
...
void co_while_cond(const struct cnode *cond, struct cnode *while_token, struct cnode *closing_bracket_token);
