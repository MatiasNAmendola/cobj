...
static ssize_t
str_len(COStrObject *this)
{
    return CO_SIZE(this);
}

static int
str_contains(COStrObject *this, COObject *o)
{
    if (!COStr_Check(o) || CO_SIZE(o) != 1) {
        COErr_SetString(COException_TypeError, "arg must be one-char str");
        return -1;
    }
